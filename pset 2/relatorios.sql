...
ON f.numero_departamento = d.numero_departamento 
		...
		QUESTÃO 4: ALTERAR 
SELECT CONCAT (primeiro_nome ,' ', nome_meio, ' ', ultimo_nome) AS nome, FLOOR(DATEDIFF(NOW(), data_nascimento) / 365.25) AS idade, f.data_nascimento, f.salario AS salarioAtual,
